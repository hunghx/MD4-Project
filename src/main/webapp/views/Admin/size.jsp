                        ...
                        <table id="example1" class="table table-bordered table-striped text-center">
                            ...
                            <c:forEach items="${listSize}" var="size">
                                <tr>
                                    ...
                                    <td>
                                        <input type="hidden" id="sizeDeleteId" value="${size.sizeId}">

                                            <%--                                        <a type="button" href="#updateCatalogModal" class="update" data-bs-toggle="modal"></a>--%>
                                        <button type="button" class="btn btn-warning" data-bs-toggle="modal"
                                                data-bs-target="#updateSizeModal" data-bs-whatever="${size.sizeId}" id="updateSize">Update
                                        </button>

                                            <%---------------------------------modal update-------------------------------%>
                                        <div class="modal fade" id="updateSizeModal" tabindex="-1"
                                             aria-labelledby="updateSizeLabel" aria-hidden="true">
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title" id="updateSizeLabel">Update
                                                            size</h5>
                                                        <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                                aria-label="Close"></button>
                                                    </div>
                                                        ...
                                                        <div class="modal-body">
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       ...
                                                                       name="sizeIdUpdate" id="sizeIdUpdate" readonly>
                                                            </div>
                                                            <div class="input-group mb-3">
                                                                ...
                                                                <input type="text" class="form-control"
                                                                       ...
                                                                       aria-label="sizeName"
                                                                       aria-describedby="basic-addon1"
                                                                       name="sizeNameUpdate" id="sizeNameUpdate">
                                                            </div>
                                                            <div class="input-group mb-3">
                                                    <span class="input-group-text"
                                                          id="sizeStatusUpdate">Trạng thái size</span>
                                                            </div>
                                                            <c:choose>
                                                                <c:when test="${size.sizeStatus}">
                                                                    <input type="radio" name="sizeStatusUpdate" id="active" value="true" checked/>
                                                                    <label for="active">Hoạt động</label>
                                                                    <input type="radio" name="sizeStatusUpdate" id="inactive" value="false"/>
                                                                    <label for="inactive">Không hoạt động</label>
                                                                </c:when>
                                                                <c:otherwise>
                                                                    <input type="radio" name="sizeStatusUpdate" id="active" value="true"/>
                                                                    <label for="active">Hoạt động</label>
                                                                    <input type="radio" name="sizeStatusUpdate" id="inactive" value="false" checked/>
                                                                    <label for="inactive">Không hoạt động</label>
                                                                </c:otherwise>
                                                            </c:choose>
                                                        </div>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-danger" data-bs-toggle="modal"
                                                data-bs-target="#exampleModal" id="deleteSize"
                                                data-bs-whatever="${size.sizeName}">Delete
                                        </button>
                                        <div class="modal fade" id="exampleModal" tabindex="-1"
                                            ...
                                            <div class="modal-dialog">
                                                <div class="modal-content">
                                                    ...
                                                    <form action="<%=request.getContextPath()%>/SizeServlet">
                                                        <div class="modal-body">
                                                            <div class="mb-3">
                                                                <input type="text" class="form-control"
                                                        ...
                                                        <div class="modal-footer">
                                                            ...
                                                            <input type="submit" class="btn btn-danger" value="Delete"
                                                                   name="action"/>
                                                            <input type="hidden" name="sizeDelId" id="sizeDelId">
                                                        </div>
                                                    </form>
                                                </div>
                                            </div>
